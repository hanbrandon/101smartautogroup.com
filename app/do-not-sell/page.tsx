      ...
      <main className="pt-40 pb-20">
        <div className="max-w-4xl mx-auto px-6">
          <header className="mb-16">
            <div className="flex items-center gap-3 text-red-500/60 mb-6">
              <Scale size={16} />
            ...
            <section className="bg-white/5 border border-white/10 p-8 md:p-12 rounded-[40px] relative overflow-hidden backdrop-blur-md">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                ...
                <div className="w-full md:w-auto">
                  {isOptedOut ? (
                    <div className="bg-red-500/10 border border-red-500/20 rounded-3xl p-8 text-center px-12 min-w-[280px]">
                      <CheckCircle2 size={32} className="text-red-500 mx-auto mb-4" />
                      <p className="text-sm font-bold text-red-500 mb-2 uppercase tracking-tighter">Privacy Shield Active</p>
                    ...
                    <button
                      ...
                      className="w-full md:w-64 bg-white text-black py-8 rounded-3xl flex flex-col items-center justify-center hover:bg-red-500 hover:text-white transition-all active:scale-95 group shadow-2xl"
                    >
                      {status === 'loading' ? (
