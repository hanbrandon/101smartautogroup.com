      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          <div className="p-10 rounded-[32px] bg-white text-black group hover:bg-gray-100 transition-colors">
            ...
            <h3 className="text-2xl font-bold mb-4 text-red-600">Custom Sourcing</h3>
          ...
          <div className="p-10 rounded-[32px] bg-white/5 border border-white/10 group hover:bg-white/10 transition-colors text-white">
            ...
            <h3 className="text-2xl font-bold mb-4 text-red-600">Inspection & Trust</h3>
          ...
          <div className="p-10 rounded-[32px] bg-white/5 border border-white/10 group hover:bg-white/10 transition-colors text-white">
            ...
            <h3 className="text-2xl font-bold mb-4 text-red-600">Financing & Leasing</h3>
          ...
          <div className="p-10 rounded-[32px] bg-white/5 border border-white/10 group hover:bg-white/10 transition-colors text-white">
            ...
            <h3 className="text-2xl font-bold mb-4 text-red-600">Trade-in & Consignment</h3>
