      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-sm md:text-base text-white/50 pt-12">
          <div className="space-y-4">
            <p className="font-bold text-red-600 uppercase tracking-widest text-xs">The Mission.</p>
          ...
          <div className="space-y-4">
            <p className="font-bold text-red-600 uppercase tracking-widest text-xs">The Expertise.</p>
          ...
          <div className="space-y-4">
            <p className="font-bold text-red-600 uppercase tracking-widest text-xs">The Advantage.</p>
